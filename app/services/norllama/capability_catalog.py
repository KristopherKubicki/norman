...
CAPABILITY_MODELS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "guardrail": "Use only through the Norllama image lane; receipts must show the backend worker and offline_local usage. Image outputs are artifacts, not factual evidence.",
    ...
    },
    {
        ...
        "guardrail": "Use as a preflight simulator; real actions still require normal policy and verification gates.",
        "default_for": ["world", "action_sim"],
    },
    {
        ...
        "guardrail": "Use to reduce browser mistakes; do not treat simulation as observed page truth.",
        "default_for": ["web_world", "browser_sim"],
    },
    {
...
def catalog_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "node_intent": {
            "spark-150": "interactive agent, code path, text memory, rerank, safety",
            "spark-151": "heavy judge, perception, documents, forecasting, estate lab",
            "mac-mini-133": "tiny fallback, canary, stream safety, injection detection",
        },
    }
