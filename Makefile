...
BEDROCK_REGION_SMOKE_MODEL ?= openai.gpt-5.6-terra
...
tui-benchmarks:
	...
	./.venv/bin/python scripts/codex_bridge_parity.py --output-json $(TUI_BENCHMARK_DIR)/codex_bridge_parity.json --output-md $(TUI_BENCHMARK_DIR)/codex_bridge_parity.md
