...
KNOWN_TOOL_NAMES = frozenset({"tool_search", "status_lookup"})
...
def _canary_prompt() -> str:
    return (
        ...
        "status_lookup in the mcp__norman_canary namespace. After its synthetic "
        "result is supplied, call status_lookup. Do not call any real MCP or "
        "external tool."
    )
