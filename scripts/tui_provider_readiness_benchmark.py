...
CANDIDATES = [
    ...
    Candidate(
        ...
        provider="aws-bedrock",
        notes="Frontier/tiebreaker candidate; 5.4 remains the default cloud baseline.",
        access_class="bedrock-serverless",
        smoke_step="Run profile-v2 Codex smoke through the work-special route picker.",
        runbook_role="High-regret second opinion for ambiguous control-plane runbooks and route-risk planning.",
    ),
    Candidate(
    ...
    Candidate(
        id="codex_bedrock_5_6_luna_low",
        label="Bedrock GPT-5.6 Luna",
        runtime="codex-bedrock",
        model="openai.gpt-5.6-luna",
        provider="aws-bedrock",
        effort="low",
        status="canary-ready",
        notes="Smoke passed on personal and work Bedrock; cheaper than 5.4, benchmark as low-cost cloud fallback.",
        activation_signals=[
            "profile-v2 smoke passes on personal and work",
            "cost-adjusted quality beats or matches 5.4 on low-risk cases",
        ],
        access_class="bedrock-serverless",
        smoke_step="Run profile-v2 Codex smoke through the work-special route picker, then low-risk status/summarization cases.",
        runbook_role="Cheap cloud fallback after local/Norllama for low-risk operator turns.",
    ),
    Candidate(
        id="codex_bedrock_5_6_terra_low",
        label="Bedrock GPT-5.6 Terra",
        runtime="codex-bedrock",
        model="openai.gpt-5.6-terra",
        provider="aws-bedrock",
        effort="low",
        status="canary-ready",
        notes="Smoke passed on personal and work Bedrock; same price class as 5.4, benchmark as default-candidate challenger.",
        activation_signals=[
            "profile-v2 smoke passes on personal and work",
            "beats 5.4 on exactness, repair, or latency at comparable cost",
        ],
        access_class="bedrock-serverless",
        smoke_step="Same profile-v2 smoke as 5.4, then the baseline readiness suite.",
        runbook_role="Default-candidate challenger for normal cloud fallback if it beats 5.4.",
    ),
    Candidate(
        id="codex_bedrock_5_6_sol_low",
        label="Bedrock GPT-5.6 Sol",
        runtime="codex-bedrock",
        model="openai.gpt-5.6-sol",
        provider="aws-bedrock",
        effort="low",
        status="canary-ready",
        notes="Smoke passed on personal and work Bedrock; same price class as 5.5, benchmark as frontier/tiebreaker challenger.",
        activation_signals=[
            "profile-v2 smoke passes on personal and work",
            "beats 5.5 on high-regret cases or offers better verifier behavior",
        ],
        access_class="bedrock-serverless",
        smoke_step="Same profile-v2 smoke as 5.5, then frontier/high-regret readiness cases.",
        runbook_role="Frontier/tiebreaker challenger for high-regret decisions only.",
    ),
    Candidate(
