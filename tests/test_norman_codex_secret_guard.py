...
@pytest.mark.parametrize(
    ...
    (
        ...
        "~/.local/lib/norman-codex-route/norman_networking_secret_broker.sh get networking/firewall",
        "python3 scripts/norman_networking_secret_broker.py get networking/firewall",
        "norman-codex-gateway-broker get networking/prompt-proxy-token",
        '"$NORMAN_SECRET_CMD" get networking/firewall',
        "bash -c '$NORMAN_SECRET_CMD get networking/firewall'",
...
@pytest.mark.parametrize(
    ...
    (
        ...
        "rg -n 'cred init' docs",
        "printf 'cred init\\n'",
        "rg -n 'norman_networking_secret_broker' scripts docs",
        "find . -name cred",
